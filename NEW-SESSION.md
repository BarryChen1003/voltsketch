...
| 功能 | 實際狀況 |
|---|---|
| **PCB 進階功能** | 🟢 2026-08-24 全數釘住：等長蛇形、疊層、背鑽、autoRoute（含多層）、DRC、差分間距、走線稽核、EMI 迴路面積、熱簡估、Gerber 讀回幾何，合計 **287 + 195 + 31 + 118 + 61 + 70 + 63 + 27 + 62 + 47** 條斷言（邏輯／Gerber 讀回／鋪銅幾何／製造功能／製造匯出／線路圖轉 PCB／DXF 板框／選取連動／STEP 3D／圖片絲印） |
