...
| 功能 | 實際狀況 |
|---|---|
| **PCB 進階功能** | 🟢 2026-08-24 全數釘住：等長蛇形、疊層、背鑽、autoRoute（含多層）、DRC、差分間距、走線稽核、EMI 迴路面積、熱簡估、Gerber 讀回幾何，合計 **287 + 195 + 31 + 118 + 61** 條斷言（邏輯＋Gerber 讀回＋鋪銅幾何＋製造功能＋製造匯出） |
...
| DXF 匯入板框 | ⬜ 未做 | — |
| ODB++ 匯出 | ⬜ 未做 | — |
| 線路圖 ↔ PCB cross-probe | ⬜ 未做（兩邊是分開的頁面，工程較大） | — |
| 圖片轉絲印 | ⬜ 未做 | — |
