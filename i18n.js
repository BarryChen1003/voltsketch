...
window.I18N = (function () {
  ...
  const D = {
    ...
    legal_upd: { zh: '最後更新：2026-07-01', en: 'Last updated: 2026-07-01', ja: '最終更新：2026-07-01', ko: '최종 업데이트: 2026-07-01' },
    ...
    tm_s2d: { zh: '訂閱取消後，已付費期間之權益維持至期末。', en: 'After cancellation, benefits for the paid period remain until the end of that period.', ja: '解約後も、支払済み期間の権益は期間満了まで維持されます。', ko: '구독 취소 후에도 결제된 기간의 혜택은 기간 만료까지 유지됩니다.' },
