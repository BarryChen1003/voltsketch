...
(function () {
  ...
  window.IC_UI = {
    zh: {
      ...
      dsOfficial: '到 TI 官網開 datasheet PDF', dsNoLink: 'datasheet：這顆不是 TI 的料，請到原廠網站查此料號。',
    ...
    en: {
      ...
      dsOfficial: 'Open the datasheet PDF on ti.com', dsNoLink: 'Datasheet: this is not a TI part - look the part number up on the manufacturer site.',
    ...
    ja: {
      ...
      dsOfficial: 'TI 公式サイトで datasheet PDF を開く', dsNoLink: 'datasheet：TI 製ではありません。メーカーのサイトで型番を検索してください。',
    ...
    ko: {
      ...
      dsOfficial: 'TI 공식 사이트에서 datasheet PDF 열기', dsNoLink: 'datasheet: TI 부품이 아닙니다. 제조사 사이트에서 부품 번호를 검색하세요.',
